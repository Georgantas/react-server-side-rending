...
var app = (0, _express2.default)(); // so that async...await works
...
exports.default = function (req, store) {
    ...
    return '\n        <html>\n            <head></head>\n            <body>\n                <div id="root">' + content + '</div>\n                <script>\n                    window.INITIAL_STATE = ' + (0, _serializeJavascript2.default)(JSON.stringify(store.getState())) + '\n                </script>\n                <script src="bundle.js"></script>\n            </body>\n        </html>\n    '; // bundle will be fetched from public since app.use(express.static('public')) specifies it
};
...
var UsersList = function (_Component) {
    ...
    _createClass(UsersList, [{
        ...
        value: function componentDidMount() {
            // not called on server side rendering
